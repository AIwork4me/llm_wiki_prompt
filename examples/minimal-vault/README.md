...
4. [pages/analyses/W-0003-attention-shortens-information-paths.md](./pages/analyses/W-0003-attention-shortens-information-paths.md)
5. [qa-reports/qa-2026-04-24-attention-self-check.md](./qa-reports/qa-2026-04-24-attention-self-check.md)
6. [index.md](./index.md) 和 [log.md](./log.md)
